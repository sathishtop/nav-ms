...
//========================================================================================================
  ...
  function new_entry($name, $email, $text) {
    global $db_name, $tbl_name, $fld_id, $fld_timestamp, $fld_name, $fld_email,
           $fld_text, $boxEntries, $reservedNames;
  ...
  function read_entries() {
    global $msg, $db_name, $tbl_name, $fld_timestamp, $messageOrder, $messageBGColors,
           $boxEntries, $boxWidth, $wordLength, $timeOffset, $reservedNames;
...
?>
      <div class="cssShoutTime" style="background-color:<? echo $bgcolor; ?>">
      <? echo $tstamp; ?>
      </div>
      <div class="<? echo $class; ?>" style="background-color:<? echo $bgcolor; ?>">
      <? if($email) echo '<a href="mailto:' . $email . '">'; ?>
      <b><? echo $name; ?>:</b><? if($email) echo '</a>'; ?> <? echo $text; ?>
      </div>
<?
    }
  }
